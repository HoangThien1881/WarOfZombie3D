...
public class ProjectileScript : MonoBehaviour {
	...
	private void OnCollisionEnter (Collision collision)
	{
        ...
        {
            // Lấy component Health của zombie
            Health zombieHealth = collision.transform.GetComponent<Health>();
            if (zombieHealth != null)
            {
                // Gây sát thương, ví dụ 10 máu mỗi phát bắn
                zombieHealth.TakeDamage(10);
            }
            // Hủy viên đạn sau khi bắn
            Destroy(gameObject);
        }
    }
}